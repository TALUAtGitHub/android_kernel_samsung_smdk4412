...
static int __maybe_unused call_modem_init_func(struct modem_ctl *mc, struct modem_data *pdata)
{
...
static struct link_device __maybe_unused *call_link_init_func(struct platform_device *pdev,
